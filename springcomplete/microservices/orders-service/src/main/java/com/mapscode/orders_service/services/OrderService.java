package com.mapscode.orders_service.services;

import com.mapscode.orders_service.model.dtos.*;
import com.mapscode.orders_service.model.entities.Order;
import com.mapscode.orders_service.model.entities.OrderItems;
import com.mapscode.orders_service.repositories.OrderRepository;
...
public class OrderService {
    ...
    public void placeOrder(OrderRequest orderRequest) {
        ...
        BaseResponse result = this.webClientBuilder.build()
                ...
                .retrieve()
                // modify the type of data that I am receiving from the service
